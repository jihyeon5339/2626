...
// --- CONFIG & APP DATA ---
// Gemini API key is required for the K-App Chat Companion to work.
// We load it from localStorage so the user doesn't need to re-enter every time.
var apiKey = "";

try {
  apiKey = (localStorage.getItem('gemini_api_key') || (typeof window !== 'undefined' ? window.__GEMINI_API_KEY__ : '') || "").trim();
} catch (e) {
  apiKey = "";
}
...
// --- Detailed secondhand guides (English) ---
var KARROT_DETAILED_GUIDE = "## Karrot (Karrot Market)\n\nKarrot (Karrot Market) works by installing the app, signing up with mobile phone verification, and setting your neighborhood to trade secondhand items based on location.\nThe key process is: sellers upload listings using the “+” button, while buyers search or save items of interest and arrange face-to-face transactions through chat.\n\n### Step 1: Install the Karrot App\n\nThe first thing you need to do is install the Karrot app to sign up. It is available on both iPhone (iOS) and Android devices.\n\n* App Store (iPhone): Search “Karrot” → Download\n* Play Store (Android): Search “Karrot” → Install\n\nOnce installed, open the app and the sign-up screen will appear automatically.\n\n### Step 2: Easy Sign-Up with Your Phone Number\n\nKarrot allows users to sign up easily using only a mobile phone number without linking an SNS account.\n\nFollow these steps:\n\n1. Open the app and tap [Get Started]\n2. Enter your mobile phone number\n3. Enter the 6-digit verification code sent by text message\n4. After verification, you will automatically move to the next step\n\n※ You cannot create multiple accounts with the same phone number, and duplicate registrations are restricted.\n\n### Step 3: Set Your Nickname\n\nAfter signing up, you need to choose a nickname that other users will see. Since your nickname can affect trust between buyers and sellers, it’s best to choose carefully.\n\n#### Good Nickname Examples\n\n* “Friendly Neighbor in Sangdo-dong”\n* “Jamsil Mom’s Secondhand Shop”\n* “Careful Trader”\n\n※ Nicknames containing profanity, advertisements, or impersonation may result in restrictions.\n\n### Step 4: Verify Your Neighborhood\n\nOne of Karrot’s core features is neighborhood-based trading. To use this feature, you must accurately verify your current location.\n\n* On the [Neighborhood Settings] screen, select “Verify My Location”\n* Your neighborhood is automatically set based on your current location, or you can manually select it on the map\n* You can set a minimum of 1 and a maximum of 2 neighborhoods\n\n※ To be recognized as a “real local neighbor,” you must verify your location directly at least twice within one month.\n\n### Step 5: Enable Notifications and Add a Profile Photo\n\nFinally, allow push notifications so you can receive transaction alerts, and upload a profile picture to improve trustworthiness.\n\n* Enable notifications: Receive real-time alerts for new chats, item listings, nearby part-time jobs, etc.\n* Add a profile photo: Using a real photo or icon instead of the default emoji can help build trust\n\n---\n\n# How to Sell on Karrot\n\n### 1. Tap the “+ Write” Button at the Bottom\n\n### 2. Select “Sell My Item”\n\n### 3. Complete Neighborhood Verification\n\nSince transactions are only available within nearby neighborhoods, you must verify your actual location.\n(Location verification is renewed every month.)\n\n### 4. Upload Photos and Write a Description\n\nTry to upload clean and realistic photos of the item.\nIn the description, include details such as size, condition, and signs of use.\n\n### 5. Tap “Complete”\n\nOnce your listing is posted, interested buyers will start contacting you through chat.\n";

var BUNJANG_DETAILED_GUIDE = "# Bunjang\n\nBunjang is a mobile marketplace app (or mobile web service) where users can search for products, buy and sell items, use secure payments, and communicate through “Bungae Talk” (chat).\nWhen purchasing, users can apply Bungae Points and coupons for discounts. Sellers are encouraged to write detailed descriptions to reduce inquiries.\n\n## How to Use Bunjang\n\n1. **Access the Platform**\n   Install the app or use the mobile website (https://m.bunjang.co.kr/) and log in.\n\n2. **Find Products**\n   Search using keywords, browse categories, or apply price filters to find the items you want.\n\n3. **Check the Seller**\n   Review the seller’s ratings, reviews, and transaction history to confirm reliability.\n\n4. **Purchase an Item**\n   Tap “Buy” on the product page → Apply Bungae Points or coupons during checkout → Complete payment.\n\n5. **Register an Item for Sale**\n   Upload photos, write a description, set a price, and publish the listing.\n\n6. **Proceed with the Transaction**\n   Use chat (“Bungae Talk”) for inquiries and negotiation. Secure payment is strongly recommended.\n\n## Bungae Points and Coupons\n\n* Bungae Points can be earned through exploration rewards, daily missions, friend invitations, and automatic rewards from purchases. They can be used like cash during payment.\n* Coupons are distributed through event banners, promotional campaigns, and special exhibitions. They are automatically or manually applied during checkout for discounts.\n* You can check your available points and coupons in the “MY” section of the app.\n\n## Tips for Safe Transactions\n\n* Check the seller’s ratings, reviews, and transaction history before purchasing.\n* Sellers should write detailed and honest descriptions, including signs of use or defects, to reduce unnecessary inquiries.\n* Consider using secure payment rather than direct transactions whenever possible.\n* Save chat records before completing transactions as a basic safety measure.\n* If your account receives restrictions, certain functions such as Bungae Talk may become limited, so check customer service notices for details.\n";

var ABLY_DETAILED_GUIDE = "# ABLY\n\n## How to Use ABLY\n\n### 1. Install the App and Log In\n\nInstall the ABLY app, then sign up or log in to start using the service.\n\n### 2. Search for Products and Add to Cart\n\nSearch for the product you want and add it to your shopping basket from the product detail page before proceeding to checkout.\n\n* After clicking a product you like, select options such as color and size for the item you want to purchase.\n* 장바구니 = Shopping Basket / Shopping Cart\n* 구매하기 = Purchase / Buy Now\n* 구매하고자 하는 물건 목록 = Shopping Basket / Cart\n\n### 3. Register Coupons\n\nGo to My Page → Coupons → Register Coupon, then enter the coupon code to add it to your account.\n\n* 배송지 = Address\n* 배송 시 요청사항을 선택해 주세요 = Please select delivery instructions\n\nCheck your available coupons and points in the Benefits section to receive discounts.\n\n* 쿠폰 = Coupon\n* 포인트 = Points\n\n### 4. Use Points\n\nDuring checkout, you can use points within the allowed limit (up to 10% of the product payment amount). Be sure to check the expiration period for points:\n\n* Purchase confirmation points: valid for 1 year\n* Review points: valid for 6 months\n\n## Using Coupons\n\n* Coupons can only be used within their validity period.\n* Some products or stores may restrict coupon use, so check the product page, store page, or checkout page for restrictions.\n* Coupons cannot be combined with other coupons.\n* When a refund is processed, the coupon value or discount amount is not included in the refund.\n* For percentage discount coupons, amounts below 10 KRW may be rounded down.\n\n## Seller Settings\n\nSellers can configure their environment in UOS by going to:\nSeller Information → Basic Information → Account Information\n\nThere, sellers can enter:\n\n* Alias\n* ID\n* Password\n* API KEY (ABLY Seller Center API Token)\n";

var ZIGZAG_DETAILED_GUIDE = "# Zigzag\n\n## How to Use Zigzag\n\n### 1. Installation and Access\n\n#### Mobile\n\nSearch for “ZIGZAG” in the Google Play Store or Apple App Store and install the app.\n\n#### PC\n\nAccess Zigzag through the official website.\n\n### 2. Browse and Purchase Products\n\n* Enter keywords in the search bar or browse categories to find products you want.\n* On the product detail page, check the size, color, price, and reviews before adding items to your wishlist or shopping basket.\n* In the shopping basket, confirm the final payment amount and complete payment using the simple payment system.\n\n### 3. Delivery and Customer Service\n\n* You can track delivery from the order details page.\n* Returns and exchanges can be processed by contacting customer service.\n";

var DELIVERED_KOREA_DETAILED_GUIDE = "# Delivered Korea\n\n## How to Use Delivered Korea\n\nDelivered Korea operates with the process:\n“We Buy → You Buy → We Ship”\n\nThe service provides users with a Korean address and helps purchase, store, and ship products internationally from Korean online shopping malls.\n\nInternational customers can also purchase products from Korean brands and marketplaces such as Bunjang and Olive Young through Delivered Korea’s official partner pages.\n\nStep 1: Browse ZIGZAG like normal\n\nFind the items you want: tops, bottoms, accessories, shoes, whatever catches your eye.\n\nStep 2: Copy the product link\n\nJust copy the URL of the item you want to buy.\n\nStep 3: Paste the link on our platform\n\nSubmit the product link on our website and select the quantity, color, size, etc. If you’re not sure about sizing or details, we can help check.\n\nStep 4: We purchase the item for you\n\nOnce you confirm and pay for your order with us, our personal shoppers will buy your ZIGZAG items directly from the sellers on your behalf.\n\nStep 5: Your items arrive at our warehouse\n\nAs soon as your items reach our warehouse, you get:\n\n• A real photo of your package\n• Weight & dimensions\n• Any important notes (defects, missing items, etc.)\n\nStep 6: Ship internationally anytime you’re ready\n\nChoose your international courier, consolidate multiple orders if you want, and we ship the final package straight to your home worldwide.\n\nOption 2: Package Forwarding – You Buy, We Ship (Ideal for Shoppers Who Want Full Control)\n\nIf you prefer shopping directly on ZIGZAG yourself, package forwarding gives you more flexibility.\n\nWhy choose You Buy, We Ship?\n\n• You check out directly on ZIGZAG using your account\n• You choose the sellers and pay them directly\n• Perfect if you want to stack coupons, membership benefits, or sales\n• Great for shoppers familiar with ZIGZAG and Korean checkout steps\n• Still enjoy lower international shipping thanks to consolidation\n\nStep 1: Sign up and get your FREE Korean address\n\nSign up and instantly receive your personal Korean warehouse address.\n\nStep 2: Ship ZIGZAG order to your free Korean address\n\nWhen checking out, just enter the Korean address we gave you. ZIGZAG will ship your items domestically to our warehouse.\n\nStep 3: Wait for your package to arrive at our warehouse\n\nWhen your package arrives, you’ll get:\n\n• A real warehouse photo\n• Package weight & measurements\n• Status updates in real-time\n\nEverything is transparent: no hidden surprises.\n\nStep 4: Combine multiple packages (optional but highly recommended)\n\nIf you ordered from several ZIGZAG shops, you can combine everything into one box. This can save you a LOT on international shipping.\n\nStep 5: Choose your international shipping method\n\nPick your preferred courier and shipping speed. We’ll pack everything securely and prepare customs forms for you.\n\nStep 6: Receive your K-fashion haul at your door\n\nTrack your shipment all the way home.\n\nWhich Option Should You Choose? (Quick Guide)\n\n• If you want zero hassle → Choose We Buy & Ship\n• If you want full control → Choose You Buy, We Ship\n";
var APP_DIRECTORY = [{
  id: 'naverMap',
...
function App() {
  ...
  // This is intentionally simple: it explains common Korean delivery/marketplace phrases
  // and provides 2-3 polite reply templates.
  var localCompanion = function localCompanion(inputMsg) {
    var text = (inputMsg || '').trim();
    var hasKorean = /[\u3131-\uD79D]/.test(text);

    var koToEnPhrases = [{
      re: /배달\s*완료|배송\s*완료/,
      en: "Delivery is completed."
    }, {
      re: /문\s*앞|현관\s*앞/,
      en: "in front of the door"
    }, {
      re: /경비실/,
      en: "security office"
    }, {
      re: /부재\s*중|없(?:어|어서|습니다)/,
      en: "not at home / unavailable"
    }, {
      re: /전화\s*(?:부탁|주세요)|연락\s*(?:부탁|주세요)/,
      en: "Please call/contact me."
    }, {
      re: /지연/,
      en: "delay"
    }, {
    ...
    var enToKoPhrases = [{
      ...
      re: /\bsecurity office\b/gi,
      ko: "경비실"
    }, {
      re: /\bfront of the door\b/gi,
      ko: "문 앞"
    }, {
      re: /\bcall\b/gi,
      ko: "전화"
    ...
    var translateKoToEn = function translateKoToEn(ko) {
      var s = ko;
      // strip quotes
      s = s.replace(/[“”"']/g, '');

      var hits = [];
      koToEnPhrases.forEach(function (p) {
        if (p.re.test(s)) hits.push(p.en);
      });

      // lightweight particle/ending normalization for readability
      var normalized = s.replace(/\s+/g, ' ').trim();
      var hint = hits.length ? hits.join(' ') : "This looks like a Korean message. (Local mode can't fully translate every sentence.)";
      return {
    ...
    var translateEnToKo = function translateEnToKo(en) {
      var s = en;
      s = s.replace(/[“”"']/g, '');
      enToKoPhrases.forEach(function (p) {
        s = s.replace(p.re, p.ko);
      });
      s = s.replace(/\s+/g, ' ').trim();
      // If it still looks very English, provide a safe generic Korean template too.
      var template = "안녕하세요! 문의드립니다. 가능하실 때 답변 부탁드립니다. 감사합니다.";
      return {
        replaced: s,
        template: template
      };
    ...
    var pick = function pick() {
      ...
      return xs.filter(Boolean).slice(0, 3);
    };

    if (!text) {
      return {
        summary: "No input provided.",
        analysis: "Please paste the message you received (Korean) or describe what you want to say (English).",
        translations: []
      };
    }
    ...
    var mentionsDoor = /문\s*앞|현관/.test(text);
    var mentionsGuard = /경비|경비실/.test(text);
    var mentionsCall = /전화|연락|통화/.test(text);
    var mentionsOut = /부재|없으시|안\s*계시|외출/.test(text);
    var mentionsDelay = /지연|늦|3일|2일|내일|오늘/.test(text) || lower.includes('delay');
    var mentionsDiscount = /깎|네고|할인/.test(text) || lower.includes('discount') || lower.includes('lower the price');
    var mentionsAvailable = /가능|되나요|할\s*수|available/.test(text);

    if (hasKorean) {
      // Received Korean message -> explain in English + Korean reply templates
      var ko = translateKoToEn(text);
      var summary = "Translation (local mode) + reply options.";
      var analysis = "English meaning (best-effort): ".concat(ko.hint, "\n\nOriginal (Korean): ").concat(ko.normalized, "\n\nTip: Add a Gemini API key for full translation and richer context.");

      var replies = [{
        korean: ko.normalized,
        english: ko.hint,
        context: "Local translation (best-effort)"
      }];
      if (mentionsGuard) {
        replies = replies.concat(pick({
          korean: "네, 경비실에 맡겨주셔도 됩니다. 감사합니다!",
          english: "Yes, you can leave it at the security office. Thank you!",
          context: "When the driver asks to leave it at the guard room."
        }, {
          korean: "죄송하지만 경비실 대신 문 앞에 두고 벨 한 번만 눌러주실 수 있을까요?",
          english: "Sorry, could you leave it at my door and ring once instead of the security office?",
          context: "When you prefer door delivery."
        }, {
          korean: "지금 집에 없어서 경비실에 맡겨주시면 제가 나중에 찾겠습니다. 감사합니다!",
          english: "I’m not home right now—please leave it at the security office and I’ll pick it up later. Thanks!",
          context: "When you’re not home."
        }));
      } else if (mentionsDoor) {
        replies = replies.concat(pick({
          korean: "문 앞에 두고 벨 한 번 눌러주시면 감사하겠습니다!",
          english: "Please leave it at my door and ring the bell once. Thank you!",
          context: "Standard door-drop request."
        }, {
          korean: "문 앞에 놓아주시고 사진으로 인증 부탁드립니다. 감사합니다!",
          english: "Please leave it at my door and send a photo as proof. Thanks!",
          context: "When you want photo proof."
        }, {
          korean: "지금 바로 내려가겠습니다. 잠시만 기다려주세요!",
          english: "I’ll come down right now. Please wait a moment!",
          context: "When meeting the driver in person."
        }));
      } else if (mentionsCall) {
        replies = replies.concat(pick({
          korean: "네, 지금 통화 가능합니다. 전화 주세요!",
          english: "Yes, I can take a call now. Please call me!",
          context: "When the driver asks to call."
        }, {
          korean: "지금은 통화가 어려워서 문자로 안내 부탁드립니다. 감사합니다!",
          english: "I can’t take a call right now—please guide me by text. Thank you!",
          context: "When you can’t answer calls."
        }));
      } else if (mentionsDelay) {
        replies = replies.concat(pick({
          korean: "확인했습니다. 배송 지연 괜찮습니다. 감사합니다!",
          english: "Confirmed. The delay is okay. Thank you!",
          context: "When you accept the delay."
        }, {
          korean: "대략 언제쯤 배송될지 일정 안내 부탁드립니다.",
          english: "Could you tell me the expected delivery date/time?",
          context: "When you need a clear ETA."
        }, {
          korean: "지연이 길어지면 취소 가능한지도 알려주세요.",
          english: "If the delay becomes long, please let me know if cancellation is possible.",
          context: "When you want a cancellation option."
        }));
      } else if (mentionsDiscount) {
        replies = replies.concat(pick({
          korean: "죄송하지만 이미 최저가라서 네고는 어렵습니다.",
          english: "Sorry, it’s already my lowest price, so I can’t negotiate.",
          context: "Polite firm decline for price negotiation."
        }, {
          korean: "죄송합니다. 네고는 어렵지만 바로 거래하시면 빠르게 진행해드릴게요.",
          english: "Sorry, I can’t lower the price, but if you buy now I can proceed quickly.",
          context: "Decline negotiation but encourage the deal."
        }, {
          korean: "죄송하지만 네고는 어렵습니다. 관심 가져주셔서 감사합니다!",
          english: "Sorry, I can’t negotiate. Thank you for your interest!",
          context: "Short and polite."
        }));
      } else {
        replies = replies.concat(pick({
          korean: "네, 확인했습니다. 감사합니다!",
          english: "Yes, I’ve checked it. Thank you!",
          context: "Generic safe acknowledgement."
        }, {
          korean: "죄송하지만 제가 잘 이해하지 못했습니다. 다시 한 번 자세히 안내해주실 수 있을까요?",
          english: "Sorry, I didn’t fully understand. Could you explain again in more detail?",
          context: "When you need clarification."
        }, {
          korean: "지금은 바로 답장이 어려워서 잠시 후에 연락드리겠습니다. 감사합니다!",
          english: "I can’t reply immediately. I’ll contact you again shortly. Thanks!",
          context: "When you need time."
        }));
      }
    ...
    // English input -> generate Korean templates
    var en = translateEnToKo(text);
    var summaryEn = "Translation (local mode) + reply templates.";
    var analysisEn = "Korean (best-effort): ".concat(en.replaced, "\n\nIf the result looks odd, use this safe template: ").concat(en.template, "\n\nTip: Add a Gemini API key for real translation.");

    var englishReplies = [{
      korean: en.replaced || en.template,
      english: text,
      context: "Local translation (best-effort)"
    }];
    if (mentionsDiscount) {
      englishReplies = englishReplies.concat(pick({
        korean: "죄송하지만 가격 네고는 어렵습니다.",
        english: "Sorry, I can’t negotiate the price.",
        context: "Declining a discount request."
      }, {
        korean: "죄송합니다. 가격은 그대로이고, 원하시면 거래 일정은 최대한 맞춰드릴게요.",
        english: "Sorry, the price stays the same, but I can be flexible with the meeting time.",
        context: "Decline but stay friendly."
      }));
    } else if (mentionsDelay) {
      englishReplies = englishReplies.concat(pick({
        korean: "확인했습니다. 배송 지연 괜찮습니다. 감사합니다!",
        english: "Confirmed. The delay is okay. Thank you!",
        context: "Accepting a delivery delay."
      }, {
        korean: "대략 언제쯤 도착하는지 알려주실 수 있을까요?",
        english: "Could you tell me roughly when it will arrive?",
        context: "Asking for an ETA."
      }));
    } else if (mentionsAvailable || lower.includes('available')) {
      englishReplies = englishReplies.concat(pick({
        korean: "아직 가능하면 구매하고 싶습니다. 지금 거래 가능할까요?",
        english: "If it’s still available, I’d like to buy it. Can we trade now?",
        context: "Checking availability and proposing a deal."
      }, {
        korean: "아직 판매 중인가요?",
        english: "Is it still for sale?",
        context: "Short availability check."
      }));
    } else {
      englishReplies = englishReplies.concat(pick({
        korean: "안녕하세요! 문의드립니다. 가능하실 때 답변 부탁드립니다.",
        english: "Hello! I have a question. Please reply when you can.",
        context: "Generic polite opener."
      }, {
        korean: "죄송하지만 다시 한 번 안내 부탁드립니다.",
        english: "Sorry, could you explain again?",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "bg-white p-4 rounded-2xl border border-rose-100 text-xs"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-extrabold text-xs mb-2 text-rose-900"
  }, "ABLY Detailed Guide (English)"), /*#__PURE__*/React.createElement("pre", {
    className: "whitespace-pre-wrap leading-relaxed text-slate-700 font-sans"
  }, ABLY_DETAILED_GUIDE)), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", {
    className: "text-xs text-slate-800 block"
    ...
    className: "bg-white p-4 rounded-2xl border border-fuchsia-100 text-xs"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-extrabold text-xs mb-2 text-fuchsia-900"
  }, "Zigzag Detailed Guide (English)"), /*#__PURE__*/React.createElement("pre", {
    className: "whitespace-pre-wrap leading-relaxed text-slate-700 font-sans"
  }, ZIGZAG_DETAILED_GUIDE)), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", {
    className: "text-xs text-slate-800 block"
    ...
    className: "bg-white p-4 rounded-2xl border border-amber-200 text-xs"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-extrabold text-xs mb-2 text-amber-900"
  }, "Delivered Korea Detailed Guide (English)"), /*#__PURE__*/React.createElement("pre", {
    className: "whitespace-pre-wrap leading-relaxed text-slate-700 font-sans"
  }, DELIVERED_KOREA_DETAILED_GUIDE)), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", {
    className: "text-xs text-slate-800 block"
    ...
    className: "bg-white p-4 rounded-2xl border border-orange-100 text-xs"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-extrabold text-xs mb-2 text-orange-900"
  }, "Karrot Detailed Guide (English)"), /*#__PURE__*/React.createElement("pre", {
    className: "whitespace-pre-wrap leading-relaxed text-slate-700 font-sans"
  }, KARROT_DETAILED_GUIDE)), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", {
    className: "text-xs text-slate-800 block"
    ...
    className: "font-extrabold text-xs mb-2 text-rose-900"
  }, "Bunjang Detailed Guide (English)"), /*#__PURE__*/React.createElement("pre", {
    className: "whitespace-pre-wrap leading-relaxed text-slate-700 font-sans"
  }, BUNJANG_DETAILED_GUIDE)), /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", {
    className: "text-xs text-slate-800 block"
    ...
    onClick: function onClick() {
      if (!apiKey || !apiKey.trim()) {
        // No API key: use local fallback mode instead of blocking the user.
        setAiError('');
        setAiOutput(localCompanion(aiInput));
        showToast('Local mode: no API key needed');
        return;
      }
